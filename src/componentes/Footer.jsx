            ...
            <div className='d-flex flex-column flex-lg-row justify-content-evenly align-items-center mb-5  p-4'>
                ...
                <div className=' p-2'>
                    ...
                    <div className='d-flex justify-content-center border-dark p-2'>
                        ...
                        <Link to="https://www.linkedin.com/in/alexmb356/" className='mr-2'>
                            <FontAwesomeIcon icon={faLinkedinIn} style={{color: "#000000",}} size='lg' />Alexander Mora
                        </Link>
                        <Link to="https://www.linkedin.com/in/sebastian-fernando-pozzi/"className='mr-2'>
                            <FontAwesomeIcon icon={faLinkedinIn} style={{color: "#000000",}} size='lg'/>Sebastian Pozzi
                        </Link>
                        <Link to="https://www.linkedin.com/in/juan-zalazar-60252a222/"className='mr-2'>
                            <FontAwesomeIcon icon={faLinkedinIn} style={{color: "#000000",}} size='lg'/>Juan Salazar
                        </Link>
                        <Link to="https://www.linkedin.com/in/gustavoalbinoromero/"className='mr-2'>
